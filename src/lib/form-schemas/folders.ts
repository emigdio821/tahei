import { z } from 'zod'
import { DESCRIPTION_MAX_LENGTH, FOLDER_NAME_MAX_LENGTH } from '../constants'
...
export const createFolderSchema = z.object({
  ...
  description: z.string().max(DESCRIPTION_MAX_LENGTH, 'Folder description must be less than 200 characters'),
